...
$(document).ready(function(){
    $.get("update.xml",{},function(xml){
      $('update',xml).each(function(i) {
        ...
        var info = ((xml.getElementsByTagName('info')[i]).childNodes[0]).nodeValue;
        document.getElementById("ver").innerHTML = "v" + version
        document.getElementById("download").href = url

        $.getJSON(info, function(data){
        var download_count = data.assets[0].download_count
        document.getElementById("download-count").innerHTML = download_count
      });
      });
    });
});